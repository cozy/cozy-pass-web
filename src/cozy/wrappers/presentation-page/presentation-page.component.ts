...
export class PresentationPageComponent extends AngularWrapperComponent implements OnInit, OnDestroy {
    constructor(
    ...
    protected async getProps(): Promise<PresentationPageProps> {
    ...
    protected async renderReact() {
        ReactDOM.render(
            React.createElement(PresentationPage, await this.getProps()),
            this.getRootDomNode()
        );
    }
}
